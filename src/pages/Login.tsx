          ...
          <div className="w-full md:w-1/2 md:order-2">
            ...
            <div className="ibox-content bg-gray-100 w-[80%] mx-auto text-whitetext-left p-[1rem]">
              ...
              <form className="flex-col w-[80%] mx-auto">
                ...
                <br />
                <button type="submit" className="btn bg-green-500 text-white w-full m-b p-2">Login</button>
                <a className="text-black mt-[20px]" href="/password/forgot">Esqueceu a senha?</a>
                <p className="text-white text-center">
                  <small className="text-black">Não tem conta?</small>
                </p>

                <hr className="hr-line-solid" />
                <a href="/register" className="border border-green-500 text-green-500 block text-center p-2 mt-2 text-black">Criar uma conta</a>
              </form>
